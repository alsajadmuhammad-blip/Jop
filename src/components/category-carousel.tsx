...
export function CategoryCarousel({ categories }: { categories: Category[] }) {
  return (
    ...
    >
      <nav className="md:hidden overflow-x-auto pb-2 max-w-full" style={{ WebkitOverflowScrolling: "touch" }}>
          ...
          {categories.map((category) => {
            ...
            return (
              <Link
                ...
                className="block group flex-shrink-0 min-w-[80px] whitespace-nowrap"
              >
                <div className="h-full overflow-hidden transition-all duration-200 bg-card/50 border border-border/30 shadow-xs hover:shadow-sm hover:border-primary/40 hover:bg-card rounded-lg">
                  <div className="flex flex-col items-center justify-center p-2 aspect-square">
