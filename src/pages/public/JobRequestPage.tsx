...
export function JobRequestPage({ onNavigate, onSubmitted }: JobRequestPageProps) {
  ...
  const validateStep = (step: number) => {
    ...
    if (step === 2 && (!form.contact_name.trim() || (!form.contact_email.trim() && !form.contact_whatsapp.trim()))) {
