...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-auto sm:right-0 sm:top-0 sm:flex-col md:max-w-md",
      className
    )}
    {...props}
  />
...
type ToastProps = React.ComponentPropsWithoutRef<typeof Toast> & { productImage?: string };
