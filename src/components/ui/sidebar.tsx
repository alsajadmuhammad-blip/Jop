  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-300 fixed inset-y-0 z-10 hidden h-screen w-[--sidebar-width] transition-[left,right,width] ease-in-out md:flex",
            side === "right"
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[side=right]:md:peer-data-[state=collapsed]:peer-data-[variant=inset]:mr-2 peer-data-[side=right]:md:peer-data-[variant=inset]:mr-0",
        className
      )}
      {...props}
    />
