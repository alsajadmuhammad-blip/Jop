...
export function StoreHero({ store }: StoreHeroProps) {
  ...
  return (
    <section className="overflow-hidden rounded-[2rem] bg-slate-950 shadow-xl shadow-slate-900/15 mb-10">
      <div className="relative isolate overflow-hidden">
        <div className="absolute -left-20 -top-10 h-72 w-72 rounded-full bg-primary/20 blur-3xl" />
        <div className="absolute -right-20 top-1/2 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl" />
        <div className="grid gap-6 lg:grid-cols-[1.45fr_1fr]">
          <div className="relative min-h-[380px] bg-slate-900 overflow-hidden rounded-xl">
            {store.coverImageUrl ? (
              <Image
            ...
            <div className="absolute left-6 top-6 rounded-2xl bg-white/20 p-2 backdrop-blur-xl border border-white/30">
          ...
          <div className="p-6 sm:p-8 lg:p-10 flex flex-col justify-between gap-6 text-white">
            <div className="grid gap-4">
              ...
              <div className="grid gap-3 grid-cols-2 gap-y-4">
                <div className="rounded-2xl bg-white/15 p-4 border border-white/20 backdrop-blur-sm flex flex-col items-center justify-center">
