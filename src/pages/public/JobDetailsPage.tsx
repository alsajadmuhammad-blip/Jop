import { ArrowLeft, ArrowRight, BriefcaseBusiness, Building2, CalendarDays, Check, Clock3, Mail, MapPin, MessageCircle, Share2 } from "lucide-react";
...
export function JobDetailsPage({ job, onNavigate }: { job: Job | null; onNavigate: (view: View) => void }) {
  ...
  return <section className="container page-section job-details-page">
    ...
    <div className="job-details-hero">
     ...
     <div className="job-details-published"><CalendarDays size={14} /> نُشرت في {formatDate(job.created_at)}</div>
